...
Yes — natively on Windows 10 1809+ and Windows 11 (x64). Get the setup wizard or portable ZIP from the [official Empryo download page](https://empryo.com/download). Empryo is not distributed through WinGet or GitHub Releases.
